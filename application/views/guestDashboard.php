                    ...
                    <?php foreach ($researchTable->result() as $row) { ?>
                        ...
                        <tr>
                            ...
                            <?php $view = base_url() . "PdfViewer?f=$row->filename" ?>
                                <a href="<?= $view ?>" target="_blank"><button type="button" class="btn ink-reaction btn-raised btn-info"><i class="fa fa-eye" style="color: black; font-size: 20px" aria-hidden="true"></i></button></a>
                            </td>
                        </tr>
                    <?php } ?>
                </tbody>
